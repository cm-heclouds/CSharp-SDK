...
namespace OneNET.Api.Util
{
    ...
    public sealed class RequestValidator
    {
        ...
        public static void ValidateRequired(string name, object value)
        {
            if (value == null)
            {
                throw new OneNETException(ERR_CODE_PARAM_MISSING, string.Format(ERR_MSG_PARAM_MISSING, name));
            }
            else
            {
        ...
        public static void ValidateMaxLength(string name, string value, int maxLength)
        {
            ...
            {
                throw new OneNETException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
            }
        }
