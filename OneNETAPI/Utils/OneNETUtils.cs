...
namespace OneNET.Api.Util
{
    ...
    /// OneNET系统工具类。
    /// </summary>
    public abstract class OneNETUtils
    {
        /// <summary>
        /// 给OneNET请求签名。
        /// </summary>
        /// <param name="parameters">所有字符型的OneNET请求参数</param>
        /// <param name="secret">签名密钥</param>
        /// <returns>签名</returns>
        //public static string SignOneNETRequest(IDictionary<string, string> parameters, string secret)
        //{
        //    return SignOneNETRequest(parameters, secret, false);
        //}
        ...
        /// <returns>签名</returns>
        //public static string SignOneNETRequest(IDictionary<string, string> parameters, string secret, bool qhs)
        //{
        //    // 第一步：把字典按Key的字母顺序排序
        ...
        //    return VerifyOneNETResponse(topParams, topSession, topSign, appKey, appSecret);
        //}
        ...
        /// <param name="appSecret">应用密钥</param>
        /// <returns>验证成功返回True，否则返回False</returns>
        public static bool VerifyOneNETResponse(string topParams, string topSession, string topSign, string appKey, string appSecret)
        {
            StringBuilder result = new StringBuilder();
        ...
        //public static OneNetContext GetOneNetContext(string authCode)
        //{
        ...
        /// <summary>
        /// 解释OneNET回调参数为键值对（采用GBK字符集编码）。
        /// </summary>
        /// <param name="topParams">经过BASE64和URL编码的字符串</param>
        /// <returns>键值对</returns>
        public static IDictionary<string, string> DecodeOneNETParams(string topParams)
        {
            return DecodeOneNETParams(topParams, Encoding.GetEncoding("GBK"));
        }
        ...
        /// <returns>键值对</returns>
        public static IDictionary<string, string> DecodeOneNETParams(string topParams, Encoding encoding)
        {
        ...
        {
            var pos = api.IndexOf(".", StringComparison.Ordinal);
